...
namespace Twoems.PoolCloud.Tests.Sessions
{
    public abstract class PoolCloudTestBase : AbpIntegratedTestBase
    {
        protected PoolCloudTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<PoolCloudApplicationModule>();
            modules.Add<PoolCloudDataModule>();
        }

        public void UsingDbContext(Action<PoolCloudDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<PoolCloudDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<PoolCloudDbContext, T> func)
        {
            T result;
